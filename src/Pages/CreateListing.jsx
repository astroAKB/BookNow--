      ...
      <form>
        ...
        {offer && (
          ...
          <div>
            ...
            <div className="flex w-full justify-center items-center space-x-6 ">
            <input type="number" id="discountedPrice" value={discountedPrice} onChange={onChange} min="50" max="50000000" required={offer}
            className="w-full px-4 py-2 text-xl text-center text-black bg-[#F8F5E4] border border-gray-300 rounded transition duration-150 ease-in-out focus:text-gray-700 focus:bg-[#F8F5E4] focus:border-slate-600 "/>
            {type === 'rent' && (
              <div>
                <p className="text-md w-full whitespace-nowrap">$ / Month</p>
        ...
        <div className="mb-6">
          ...
          <input type="file" id="images" onChange={onChange} accept=".jpeg,.png,.jpg" multiple required className="w-full px-3 py-1.5 text-gray-700 bg-[#F8F5E4] border border-gray-300 rounded transition duration-150 ease-in-out focus:bg-[#F8F5E4] focus:border-slate-600 "/>
        </div>
